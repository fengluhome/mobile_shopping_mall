    ...
    <ul class="section3-list">
      <li v-for="k in list" :key='k.id'>
        <div class="section3-list-left">
          <h4>{{k.title}}</h4>
          <div class="time">
            <span class="time-num">{{k.dom.num1||'12'}}</span>
        ...
        <router-link :to="{name:'详情页'}" class="section3-list-right">
  ...
  export default {
    data() {
      return {
        ...
        'title':'电冰箱',
        'start':'13:00:00',
        'imgPath': require('../../assets/images/电冰箱.jpg'),
        'id':'1',
        'price':999,
        'end':'14:00:00'
          },
        ...
        banner:require('../../assets/images/banner3.jpg'),
        dom: [{
          num1: '',
          num2: '',
          num3: ''
    ...
    methods: {
      ...
      this.axios({
        ...
        for (let i of this.dom.keys()) {
          setTime(resDatas.data[i].end, this.dom[i])
